    ...
    <body>
        ...
        <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3><img src="img/icontest3.png" alt="Logo" /></h3></div>
                ...
                <span class="centre"><a type="submit" href="index.html" class="btn btn-block btn-large btn-info" style="color: black; background-color: #ffff33; padding: 15px 30px; font-size: 20px; border-radius: 4px; text-decoration: none; display: inline-block; text-align: center;"> Return Back</a></span>
            </form>
            <?php
